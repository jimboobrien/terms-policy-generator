...
<h1 style="text-align: center; ">VQDEV Terms of Service Generator</h1>
	...
	<div ng-app="">
		...
		<div class="container">
				...
				<div class="row">
					<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<input type="email" ng-model="emailadd" class="form-control" id="emailadd" placeholder="Email">
								</div>
						...
						<div class="row">
							...
							<div class="col-xs-3">
								<div class="form-group">
									...
									<input type="text" ng-model="state" class="form-control" id="state" placeholder="State">
								</div>
							</div>
							<div class="col-xs-3">
								<div class="form-group">
									<label for="zip">Zip</label>
									<input type="text" ng-model="zip" class="form-control" id="zip" placeholder="Zip">
								</div>
							</div>
						</div>
					</div>
				...
				<div class="row">
					<div class="col-xs-6">
						<div class="form-group">
							...
							<input type="text" ng-model="website" class="form-control" id="website" placeholder="Website">
						</div>
					</div>
					...
					<div class="col-xs-6">
						<div class="form-group">
							...
							<input type="text" ng-model="webhost" class="form-control" id="webhost" placeholder="Bluehost, Hostgator, Godaddy, etc.">
						</div>
					</div>
				</div>
			...
			<button type="button" class="btn btn-primary tos-btn"  onclick="generate_tos()" data-clipboard-target="#terms-and-conditions">Copy to clipboard</button>
			...
			<div id="terms-and-conditions" >
				...
				<p>This website is operated by {{compname}}. Throughout the site, the terms “we”, “us” and “our” refer to {{compname}}. {{compname}} offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.
				...
				Our store is hosted on {{webhost}}. They provide us with the online e-commerce platform that allows us to sell our products and services to you.</p>
				...
				In no case shall {{compname}}, our directors, officers, employees, affiliates, agents, contractors, interns, suppliers, service providers or licensors be liable for any injury, loss, claim, or any direct, indirect, incidental, punitive, special, or consequential damages of any kind, including, without limitation lost profits, lost revenue, lost savings, loss of data, replacement costs, or any similar damages, whether based in contract, tort (including negligence), strict liability or otherwise, arising from your use of any of the service or any products procured using the service, or for any other claim related in any way to your use of the service or any product, including, but not limited to, any errors or omissions in any content, or any loss or damage of any kind incurred as a result of the use of the service or any content (or product) posted, transmitted, or otherwise made available via the service, even if advised of their possibility. Because some states or jurisdictions do not allow the exclusion or the limitation of liability for consequential or incidental damages, in such states or jurisdictions, our liability shall be limited to the maximum extent permitted by law.

				<strong>SECTION 14 - INDEMNIFICATION</strong>
				
				<p>You agree to indemnify, defend and hold harmless {{compname}} and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.</p>
				...
				<p>These Terms of Service and any separate agreements whereby we provide you Services shall be governed by and construed in accordance with the laws of {{address}} {{city}}, {{state}} {{zip}}, United States.</p>
				...
				<p>Questions about the Terms of Service should be sent to us at {{emailadd}}.</p>
